...
| **Positional reading of the joined doors (`+jkl`)**: Base64 positions 31/73/137/143 on SalPhaseIon ‖ 1 char ‖ P32T; `k` forced by the `Salted__` header, `+` shared, needs a mixed line-break rule; about 1 in 58 over the constructions in play; 137/143 has no source | **coincidence marker, not admissible** (no gate exception) | 94 |
