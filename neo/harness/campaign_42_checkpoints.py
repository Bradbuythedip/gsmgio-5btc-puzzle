#!/usr/bin/env python3
"""Campaign 42: five checkpoint preimages verbatim, pre-registered in
intake/2026-09-26-checkpoints/PREREG.md. Uses gate.py's frozen functions unchanged."""
import json, time, os
...
OUT = os.path.join(gate.NEO, "attempts", "campaign_42_checkpoints.jsonl")
