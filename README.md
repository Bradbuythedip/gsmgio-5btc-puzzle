...
## 2026-01-01 New Year's Hint

![new years hint](hints/2026-01-01-new-year-hint.png)

### Decode

Use a simple ["binary to ascii" conversion](https://gchq.github.io/CyberChef/#recipe=From_Binary('Space',8)&input=)
